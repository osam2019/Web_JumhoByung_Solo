					...
					<span>
						<span 
							style={{
								height: '10px', 
								width: '10px', 
								backgroundColor:  original.morningAttend === true ? '#57d500' :'#ff2e00',
								borderRadius: '50%', 
					...
					<span>
						<span 
							style={{
								height: '10px', 
								width: '10px', 
								backgroundColor:  original.eveningAttend === true ? '#57d500' :'#ff2e00',
								borderRadius: '50%', 
								display: 'inline-block',
								transition: 'all .3s ease ease-out',
								}} 
